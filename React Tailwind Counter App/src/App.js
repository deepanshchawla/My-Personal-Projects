...
function App() {
  ...
  return (
    <div className="w-[100vw] h-[100vh] flex justify-center bg-[#344151] gap-10 flex-col items-center">
      <div className="text-[#0398d4] font-medium text-2xl">
        Increment & Decrement
      </div>

      <div className="flex bg-white flex-row justify-center py-3 rounded-sm text-[25px] text-[#344151] gap-12">
